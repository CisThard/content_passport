<!-- Source: https://seal-docs.wal.app/SecurityBestPractices -->
...
## Choose an appropriate threshold configurationâ
...
## Vet and establish relationships with key server providersâ
...
## Use layered encryption for critical or large dataâ
...
## Use the symmetric key from the `encrypt` API with careâ
...
## Understand the risks of leaked decryption keysâ
...
[PreviousAccess Policy Example Patterns](</ExamplePatterns>)[NextKey Server Operations for Independent Server Type](</KeyServerOps>)
