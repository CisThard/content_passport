<!-- Source: https://seal-docs.wal.app/SealCLI -->
...
## 3\. (Optional) Decrypt with the symmetric keyâ
...
## 4\. Extract user secret keys (for threshold decrypt)â
...
## 5\. Decrypt with a threshold of user keysâ
...
## 6\. Inspect an encrypted objectâ
...
## 7\. Encrypt and fetch keys using service providersâ
...
[PreviousAggregator Server](</Aggregator>)[NextSeal Pricing](</Pricing>)
