<!-- Source: https://docs.wal.app/walrus-memory/sdk/usage/memwal-manual -->
...
Use when the client must handle embedding calls and local Seal operations. The relayer still handles upload relay, vector registration, search, and restore.
...
## What the client handles vs. what the relayer handlesâ
...
## Remember flow (under the hood)â
...
## Browser integration (wallet signer)â
...
[PreviousWalrus Memory](</walrus-memory/sdk/usage/memwal>)[Next`withMemWal`](</walrus-memory/sdk/usage/with-memwal>)
