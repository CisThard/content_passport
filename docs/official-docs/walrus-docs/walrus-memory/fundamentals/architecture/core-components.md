<!-- Source: https://docs.wal.app/walrus-memory/fundamentals/architecture/core-components -->
...
**Key tables:**
  ...
  * `delegate_key_cache`, caches delegate key â account mappings for fast auth
...
[PreviousOwnership and Delegates](</walrus-memory/fundamentals/concepts/ownership-and-access>)[NextHow Storage Works](</walrus-memory/fundamentals/architecture/how-storage-works>)
