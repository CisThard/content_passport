<!-- Source: https://docs.wal.app/walrus-memory/fundamentals/architecture/how-storage-works -->
...
[PreviousCore Components](</walrus-memory/fundamentals/architecture/core-components>)[NextTrust and Security Model](</walrus-memory/fundamentals/architecture/data-flow-security-model>)
