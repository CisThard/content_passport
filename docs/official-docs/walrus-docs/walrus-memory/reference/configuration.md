<!-- Source: https://docs.wal.app/walrus-memory/reference/configuration -->
...
[PreviousPython SDK API Reference](</walrus-memory/python-sdk/api-reference>)[NextEnvironment Variables](</walrus-memory/reference/environment-variables>)
