<!-- Source: https://docs.wal.app/walrus-memory/reference/environment-variables -->
...
Use this page when you run your own relayer. For setup steps and deployment context, see [Self-Hosting](</walrus-memory/relayer/self-hosting>).
...
`ENOKI_TRANSIENT_MAX_DELAY_MS`| `30000`| Maximum delay for one transient Enoki retry, including parsed retry hints such as âtry again in 30 secondsâ  
...
[PreviousConfiguration](</walrus-memory/reference/configuration>)
