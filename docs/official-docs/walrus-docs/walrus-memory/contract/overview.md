<!-- Source: https://docs.wal.app/walrus-memory/contract/overview -->
...
[PreviousReference](</walrus-memory/mcp/reference>)[NextDelegate Key Management](</walrus-memory/contract/delegate-key-management>)
