<!-- Source: https://docs.wal.app/walrus-memory/mcp/how-it-works -->
...
## Why login returns a URL instead of waitingâ
...
## Safety decisions in the runtimeâ
...
## What logout does and does not doâ
...
## Why docs say âretry the tool callââ
...
[PreviousQuick Start](</walrus-memory/mcp/quick-start>)[NextReference](</walrus-memory/mcp/reference>)
  ...
  * Why docs say âretry the tool callâ
  * Related pages
