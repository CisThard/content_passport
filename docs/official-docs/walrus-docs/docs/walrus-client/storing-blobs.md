...
[Edit this page](<https://github.com/MystenLabs/walrus/tree/main/docs/site/../content/walrus-client/storing-blobs.mdx>)

[PreviousWalrus Client](</docs/walrus-client/walrus-cli>)[NextReading Blobs](</docs/walrus-client/reading-blobs>)
