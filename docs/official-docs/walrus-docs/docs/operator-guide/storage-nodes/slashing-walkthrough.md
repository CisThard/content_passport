<!-- Source: https://docs.wal.app/docs/operator-guide/storage-nodes/slashing-walkthrough -->

* [](</>)
  * [Storage Nodes](</docs/operator-guide/storage-nodes>)
  * Slashing Walkthrough
...
## Day 1 of epoch N: first vote creates the proposalâ
...
## Days 1 to 10 of epoch N: collect quorumâ
...
## Quorum reached: finalize the slashingâ
...
## Cleanup of dangling proposals from prior epochsâ
...
[Edit this page](<https://github.com/MystenLabs/walrus/tree/main/docs/site/../content/operator-guide/storage-nodes/slashing-walkthrough.mdx>)

[PreviousSlashing](</docs/operator-guide/storage-nodes/slashing>)[NextBackup and Restore Guide](</docs/operator-guide/storage-nodes/backup-restore-guide>)
