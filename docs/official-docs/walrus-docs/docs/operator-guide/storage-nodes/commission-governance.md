<!-- Source: https://docs.wal.app/docs/operator-guide/storage-nodes/commission-governance -->
...
## Update the commission receiver and entity authorized for governanceâ
...
### Vote on upgrades using the web interfaceâ
...
### Vote on upgrades using the CLIâ
...
[Edit this page](<https://github.com/MystenLabs/walrus/tree/main/docs/site/../content/operator-guide/storage-nodes/commission-governance.mdx>)

[PreviousMigrate a Storage Node](</docs/operator-guide/storage-nodes/storage-node-migration>)[NextSlashing](</docs/operator-guide/storage-nodes/slashing>)
