<!-- Source: https://docs.wal.app/docs/operator-guide/storage-nodes/slashing -->
...
### Look up the candidate node IDâ
...
### Voting through an authorizing objectâ
...
### Can a node revoke its own vote?â
...
#### What happens if the candidate's commission balance is empty?â
...
#### Does slashing affect the candidate's stake or delegators?â
...
#### Can the candidate vote on its own slashing?â
...
#### Is there a slashing event in the contract?â
...
#### What stops malicious operators from spamming slashing votes?â
...
#### Can I see slashing activity in the staking app?â
...
[Edit this page](<https://github.com/MystenLabs/walrus/tree/main/docs/site/../content/operator-guide/storage-nodes/slashing.mdx>)

[PreviousCommission and Governance](</docs/operator-guide/storage-nodes/commission-governance>)[NextSlashing Walkthrough](</docs/operator-guide/storage-nodes/slashing-walkthrough>)
