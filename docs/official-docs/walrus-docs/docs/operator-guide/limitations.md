<!-- Source: https://docs.wal.app/docs/operator-guide/limitations -->

* [](</>)
  * Aggregator and Publisher Limitations
...
##### Step 1: Set permissions on the cache directory.â
[code] 
...
##### Step 2: Add a cache path directive.â
...
##### Step 3: Create a site configuration.â
...
##### Step 4: Validate the configuration.â

Run `sudo nginx -t`.

##### Step 5: Obtain a TLS certificate.â
[code] 
    sudo certbot --nginx -d YOUR_HOSTNAME  
    
[/code]

##### Step 6: Enable the site and start nginx.â
[code] 
...
[Edit this page](<https://github.com/MystenLabs/walrus/tree/main/docs/site/../content/operator-guide/limitations.mdx>)

[PreviousStaking and Unstaking](</docs/operator-guide/stake>)
