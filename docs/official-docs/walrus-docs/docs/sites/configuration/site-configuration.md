<!-- Source: https://docs.wal.app/docs/sites/configuration/site-configuration -->
...
## Ignoring files from being uploadedâ
...
[Edit this page](<https://github.com/MystenLabs/walrus/tree/main/docs/site/../content/sites/configuration/site-configuration.mdx>)

[PreviousSite Builder Reference](</docs/sites/getting-started/using-the-site-builder>)[NextSpecifying HTTP Headers](</docs/sites/configuration/specifying-http-headers>)
