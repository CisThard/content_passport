<!-- Source: https://docs.wal.app/docs/sites/linking/redirects -->
...
[ws-resources.json](<https://github.com/MystenLabs/walrus/blob/main/ws-resources.json>)
[code]
    {  
      "routes": {  
        "/*": "/index.html",  
...
### Single-page application routingâ
...
### Common redirect configurationsâ
...
## Redirecting Sui objects to a Walrus Siteâ
...
### Setting up the redirect in Moveâ
...
### Personalizing the page per objectâ
...
[Edit this page](<https://github.com/MystenLabs/walrus/tree/main/docs/site/../content/sites/linking/redirects.mdx>)

[PreviousLinking to Walrus Sites from External Sources](</docs/sites/linking/linking-to-walrus-sites>)[NextAvoiding Duplicate Content for SEO](</docs/sites/linking/avoiding-duplicate-content-seo>)
