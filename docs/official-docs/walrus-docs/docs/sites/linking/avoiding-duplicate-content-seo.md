<!-- Source: https://docs.wal.app/docs/sites/linking/avoiding-duplicate-content-seo -->
...
Walrus Sites are particularly prone to this because the same site object can be resolved under several different hostnames at the same time:
  ...
  * **Base36** : A subdomain derived directly from the site object ID, for example `1mybâ¦xd.portal.com`.
...
## How to signal a canonical URLâ
...
### Base36 subdomains on a self-hosted portalâ
...
### Multiple SuiNS names pointing to the same siteâ
...
### Sites accessible on multiple portalsâ
...
[Edit this page](<https://github.com/MystenLabs/walrus/tree/main/docs/site/../content/sites/linking/avoiding-duplicate-content-seo.mdx>)

[PreviousWalrus Sites Redirects](</docs/sites/linking/redirects>)[NextPreparing Deployment Credentials](</docs/sites/ci-cd/preparing-deployment-credentials>)
