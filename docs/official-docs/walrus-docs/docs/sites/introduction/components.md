<!-- Source: https://docs.wal.app/docs/sites/introduction/components -->

* [](</>)
  * [Introduction to Walrus Sites](</docs/sites>)
  * Walrus Sites Components
...
The public Mainnet portal operated by Mysten Labs is available at <https://wal.app>. Sites with a SuiNS name are accessible directly by name. For sites without one, use the Base36-encoded object ID as the subdomain, or run `site-builder convert` to find it.

Anyone can host their own portal. For setup instructions, see [Deploy a Local Portal](</docs/sites/portals/deploy-locally>).

[Edit this page](<https://github.com/MystenLabs/walrus/tree/main/docs/site/../content/sites/introduction/components.mdx>)

[PreviousTechnical Overview](</docs/sites/introduction/technical-overview>)[NextInstall the Site Builder](</docs/sites/getting-started/installing-the-site-builder>)
