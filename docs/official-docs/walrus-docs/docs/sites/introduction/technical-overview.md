<!-- Source: https://docs.wal.app/docs/sites/introduction/technical-overview -->

* [](</>)
  * [Introduction to Walrus Sites](</docs/sites>)
  * Technical Overview
...
## Resolving and serving a siteâ

Visitors access a Walrus Site through a portal. A portal is a service that translates a browser request into Sui and Walrus lookups, then returns a standard HTTP response. Anyone can run a portal. The Mainnet portal at <https://wal.app> is operated by Mysten Labs.

When a visitor navigates to a Walrus Site URL, the portal works through the following sequence:

  1. **Identify the site.** The portal reads the subdomain of the request URL and resolves it to a Sui object ID. The subdomain is either a SuiNS name or a Base36-encoded object ID (see Domain isolation).
...
![Diagram showing the end-to-end resolution of a Walrus Site request, from browser through portal, SuiNS, Sui dynamic fields, and Walrus aggregator.](/assets/images/walrus-sites-portal-diagram-with-quilts-492ccd1dcda79e37e64cf4dca26f05b5.svg)
...
[Edit this page](<https://github.com/MystenLabs/walrus/tree/main/docs/site/../content/sites/introduction/technical-overview.mdx>)

[PreviousWalrus Sites](</docs/sites>)[NextWalrus Sites Components](</docs/sites/introduction/components>)
