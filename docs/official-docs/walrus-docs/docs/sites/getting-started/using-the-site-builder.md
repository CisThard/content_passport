<!-- Source: https://docs.wal.app/docs/sites/getting-started/using-the-site-builder -->
...
#### How does `deploy` determine whether to publish or update a site?â
...
#### Migrating from `publish` and `update`â
...
The object ID is automatically saved to `ws-resources.json`. Subsequent deployments no longer need the flag:
[code]
...
[Edit this page](<https://github.com/MystenLabs/walrus/tree/main/docs/site/../content/sites/getting-started/using-the-site-builder.mdx>)

[PreviousDeploy a Walrus Site](</docs/sites/getting-started/publishing-your-first-site>)[NextSite Configuration](</docs/sites/configuration/site-configuration>)
