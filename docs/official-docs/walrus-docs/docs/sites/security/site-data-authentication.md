<!-- Source: https://docs.wal.app/docs/sites/security/site-data-authentication -->
...
## What authentication does and does not coverâ
...
## How hash verification relates to the `site-builder`â
...
[Edit this page](<https://github.com/MystenLabs/walrus/tree/main/docs/site/../content/sites/security/site-data-authentication.mdx>)

[PreviousOther CI/CD Platforms](</docs/sites/ci-cd/other-ci-cd-platforms>)[NextAccess Control Options](</docs/sites/security/access-control-options>)
