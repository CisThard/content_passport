<!-- Source: https://docs.wal.app/docs/sites/custom-domains/bringing-your-own-domain -->
...
When a visitor navigates to your domain, their request reaches your portal. The portal resolves the Walrus Site object and returns that site's content. Configuring the portal to serve only your domain prevents it from being used to serve other Walrus Sites.
  ...
  * A [deployed Walrus Site](</docs/sites/getting-started/publishing-your-first-site>) with a known object ID (in Base36)
  * A custom domain registered through a domain registrar, such as [Cloudflare](<https://www.cloudflare.com/products/registrar/>)
  * A server or hosting environment where you can run the Walrus Sites portal (with a public IP address), such as [DigitalOcean](<https://www.digitalocean.com/products/droplets>), [AWS EC2](<https://aws.amazon.com/ec2/>), or [GCP Compute Engine](<https://cloud.google.com/products/compute>)
  * Access to your domain's DNS settings
  * The Walrus Sites portal repository cloned and [set up locally](</docs/sites/portals/deploy-locally>)


## Get your Walrus Site object ID in Base36â
...
[portal-config.yaml](<https://github.com/MystenLabs/walrus/blob/main/portal-config.yaml>)
[code]
    network: mainnet  
...
## Deploy your portal to a serverâ
...
[Edit this page](<https://github.com/MystenLabs/walrus/tree/main/docs/site/../content/sites/custom-domains/bringing-your-own-domain.mdx>)

[PreviousSetting a SuiNS Name](</docs/sites/custom-domains/setting-a-suins-name>)[NextPortal DNS Configuration](</docs/sites/custom-domains/dns-configuration>)
