<!-- Source: https://docs.wal.app/docs/sites/known-restrictions -->
...
## Routing constraints in `ws-resources.json`â
...
## Service-worker portal limitationsâ
...
### Service-worker portals cannot serve sites that use service workersâ
...
### iOS Sui mobile wallet compatibilityâ
...
### Progressive web apps are not supportedâ
...
## Domain and naming constraintsâ
...
[Edit this page](<https://github.com/MystenLabs/walrus/tree/main/docs/site/../content/sites/known-restrictions.mdx>)

[PreviousAccess Control Options](</docs/sites/security/access-control-options>)[NextTroubleshooting Walrus Sites](</docs/sites/troubleshooting>)
