<!-- Source: https://docs.wal.app/docs/system-overview/available-networks -->
...
## Mainnet configurationâ

The client parameters for the Walrus Mainnet are:

[setup/client_config_mainnet.yaml](<https://github.com/MystenLabs/walrus/blob/main/setup/client_config_mainnet.yaml>)
[code]
...
[setup/client_config_testnet.yaml](<https://github.com/MystenLabs/walrus/blob/main/setup/client_config_testnet.yaml>)
[code]
    # NOTE: walrus-service uses these IDs to detect network defaults. Changing them changes node  
    # behavior and must be coordinated.  
...
#### Prerequisites: Sui wallet and Testnet SUIâ

  * Prerequisites


  * Download and install the [Sui CLI](</docs/getting-started#step-1-install-tooling>).

  * Create a [Sui account](</docs/getting-started#step-3-understanding-your-sui-account>).

  * Obtain [Testnet SUI](</docs/getting-started#step-4-fund-sui-account-with-tokens>).

  * Download and install [Walrus](</docs/getting-started#step-1-install-tooling>).
...
[code] 
    ...
    â âââââââââââââââââââââââââââââââââââââââ¤ â  
    â â Sui   8869252670        8.86 SUI    â â  
    â â WAL   500000000         0.50 WAL    â â  
    â â°ââââââââââââââââââââââââââââââââââââââ¯ â  
    â°ââââââââââââââââââââââââââââââââââââââââââ¯  
...
[Edit this page](<https://github.com/MystenLabs/walrus/tree/main/docs/site/../content/system-overview/available-networks.mdx>)

[PreviousSystem Constraints & Considerations](</docs/system-overview/system-constraints>)[NextStorage Costs](</docs/system-overview/storage-costs>)
