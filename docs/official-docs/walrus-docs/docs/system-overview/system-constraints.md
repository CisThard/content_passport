<!-- Source: https://docs.wal.app/docs/system-overview/system-constraints -->
...
## Byzantine fault tolerance assumptionsâ
...
## Public infrastructure availabilityâ
...
[Edit this page](<https://github.com/MystenLabs/walrus/tree/main/docs/site/../content/system-overview/system-constraints.mdx>)

[PreviousOperations](</docs/system-overview/operations>)[NextAvailable Networks](</docs/system-overview/available-networks>)
