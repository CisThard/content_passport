<!-- Source: https://docs.wal.app/docs/system-overview/quilt -->
...
Quilt is especially advantageous for managing large volumes of small blobs, as long as they can be grouped together. The cost savings come from 2 sources:
  ...
  * **Walrus storage and write fees:** By consolidating multiple small blobs into a single quilt, storage costs can be reduced dramatically â more than 400x for files around 10 KiB â making it an efficient solution for cost-sensitive applications.
...
[Edit this page](<https://github.com/MystenLabs/walrus/tree/main/docs/site/../content/system-overview/quilt.mdx>)

[PreviousView System Information](</docs/system-overview/view-system-info>)[NextWalrus Client](</docs/walrus-client>)
