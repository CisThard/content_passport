<!-- Source: https://docs.wal.app/docs/legal/privacy -->
...
## HOW WE DISCLOSE YOUR INFORMATIONâ
...
## YOUR PRIVACY CHOICES AND RIGHTSâ
...
## Request Deletion of your personal information;â
...
## RETENTION OF PERSONAL INFORMATIONâ
...
## SUPPLEMENTAL NOTICE FOR CALIFORNIA RESIDENTSâ
...
**Internet or other electronic network activity** Browsing history, search history, information on a consumerâs interaction with an internet website or application| 
...
## SUPPLEMENTAL NOTICE FOR NEVADA RESIDENTSâ
...
## THIRD-PARTY WEBSITES/APPLICATIONSâ
