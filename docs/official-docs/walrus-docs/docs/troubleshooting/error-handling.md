<!-- Source: https://docs.wal.app/docs/troubleshooting/error-handling -->
...
## Implement retry logic with exponential backoffâ
...
## Verify on-chain state after timeoutsâ
...
## Capture storage node errors with the TypeScript SDKâ
...
## Use strict consistency checks for critical dataâ
...
[Edit this page](<https://github.com/MystenLabs/walrus/tree/main/docs/site/../content/troubleshooting/error-handling.mdx>)

[PreviousTroubleshooting Common Errors](</docs/troubleshooting/network-errors>)[NextReading Blobs Right After Upload](</docs/troubleshooting/reading-blobs-after-upload>)
