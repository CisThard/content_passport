<!-- Source: https://docs.wal.app/docs/tusky-migration-guide -->
...
## Important note on encryption (applies to all migration options)â
...
## Migration option 1: Download from Tusky â decrypt â re-upload to Walrusâ
  ...
  * For encryption, either:
    ...
    * Use a third-party library (like [CryptoES](<https://www.npmjs.com/package/crypto-es>) or [Nodeâs Crypto Module](<https://medium.com/@tony.infisical/guide-to-nodes-crypto-module-for-encryption-decryption-65c077176980>) for symmetric key based encryption before upload. You can optionally use the keys that you might have retrieved from Tusky.
...
## Migration option 2: Direct Walrus access through blob or quilt patch IDsâ
...
## Migration option 3: Migrate to another Walrus-compatible interface (Managed UX)â
...
[Edit this page](<https://github.com/MystenLabs/walrus/tree/main/docs/site/../content/tusky-migration-guide.mdx>)

[PreviousData Security](</docs/data-security>)[NextGlossary](</docs/glossary>)

  * Immediate first steps
  * Important note on encryption (applies to all migration options)
  * Migration option 1: Download from Tusky â decrypt â re-upload to Walrus
