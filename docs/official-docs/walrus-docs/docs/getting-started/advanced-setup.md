<!-- Source: https://docs.wal.app/docs/getting-started/advanced-setup -->
...
[Edit this page](<https://github.com/MystenLabs/walrus/tree/main/docs/site/../content/getting-started/advanced-setup.mdx>)

[PreviousGetting Started with Walrus](</docs/getting-started>)[NextSystem Overview](</docs/system-overview>)
