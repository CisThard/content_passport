...
### Walrus and WAL packages on Mainnetâ
...
## System and staking object IDsâ
...
## Deprecated and stale endpoint patternsâ
...
[Edit this page](<https://github.com/MystenLabs/walrus/tree/main/docs/site/../content/network-reference.mdx>)

[PreviousReading Blobs Right After Upload](</docs/troubleshooting/reading-blobs-after-upload>)[NextSDKs](</docs/typescript-sdk/sdks>)
