<!-- Source: https://docs.wal.app/docs/data-security -->
...
You can learn more in the [whitepaper](</assets/files/walrus_whitepaper_v2-31701a689e75cc47048440b56789f388.pdf>) and in the [Walrus fundamentals documentation](</docs/system-overview/core-concepts>).
...
## Seal: Data confidentiality and access controlâ
...
## Nautilus: Secure and verifiable off-chain computationâ
...
[Edit this page](<https://github.com/MystenLabs/walrus/tree/main/docs/site/../content/data-security.mdx>)

[PreviousLarge Data Upload Workarounds](</docs/large-uploads>)[NextTusky Migration Guide](</docs/tusky-migration-guide>)
