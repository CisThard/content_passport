<!-- Source: https://developer.android.com/topic/libraries/architecture/room -->
...
Because of these considerations, we highly recommend that you use Room instead of [using the SQLite APIs directly](</training/data-storage/sqlite>).
...
![](/static/images/training/data-storage/room_architecture.png) **Figure 1.** Diagram of Room library architecture.
...
To learn more about data entities in Room, see [Defining data using Room entities](</training/data-storage/room/defining-data>).
...
To learn more about DAOs, see [Accessing data using Room DAOs](</training/data-storage/room/accessing-data>).
