<!-- Source: https://developer.android.com/jetpack/compose/components/switch -->
...
![Examples of the Switch component in both light and dark mode.](/static/develop/ui/compose/images/components/switches.png) **Figure 1.** The switch component.
...
[code] 
    ...
    [Switch.kt](<https://github.com/android/snippets/blob/392c3a718f8a2514bd0a55bd88b10fc17f38320a/compose/snippets/src/main/java/com/example/compose/snippets/components/Switch.kt#L65-L75>)
[/code]

This implementation appears as follows when unchecked:

![A basic switch that is unchecked.](/static/develop/ui/compose/images/components/switch-deactivated.png) **Figure 2.** An unchecked switch.

This is the appearance when checked:

![A basic Switch that is checked.](/static/develop/ui/compose/images/components/switch.png) **Figure 3.** A checked switch.
...
[code] 
    ...
    [Switch.kt](<https://github.com/android/snippets/blob/392c3a718f8a2514bd0a55bd88b10fc17f38320a/compose/snippets/src/main/java/com/example/compose/snippets/components/Switch.kt#L80-L101>)
[/code]
...
![A switch that uses the thumbContent parameter to display a custom icon when checked.](/static/develop/ui/compose/images/components/switch-icon.png) **Figure 4.** A switch with a custom checked icon.
...
[code] 
    ...
    [Switch.kt](<https://github.com/android/snippets/blob/392c3a718f8a2514bd0a55bd88b10fc17f38320a/compose/snippets/src/main/java/com/example/compose/snippets/components/Switch.kt#L129-L145>)
[/code]

This implementation appears as follows:

![A switch that uses the colors parameter to display a switch with custom colors for both the thumb and track.](/static/develop/ui/compose/images/components/switch-colors.png) **Figure 5.** A switch with custom colors.
