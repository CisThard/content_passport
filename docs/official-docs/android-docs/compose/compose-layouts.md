<!-- Source: https://developer.android.com/develop/ui/compose/layouts -->
...
## Learn more
  ...
  * **New!** Try our [Quick Guides](</quick-guides>) to get a fast and focused content experience.

  * To learn more about Compose layouts, try the [Layouts in Jetpack Compose codelab](</codelabs/jetpack-compose-layouts>).
...
[ Next Layout basics  arrow_forward  ](</develop/ui/compose/layouts/basics>)
