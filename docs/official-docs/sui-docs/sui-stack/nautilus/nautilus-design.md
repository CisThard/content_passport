<!-- Source: https://docs.sui.io/sui-stack/nautilus/nautilus-design -->
...
![image](/assets/images/nautilus-overview_nautilus-design_v1-51b2a402cde48582c65e76bb623a7ff7.png)
...
When the enclave starts, it exposes 3 HTTP endpoints:
  ...
  2. `/get_attestation`: Returns the signed attestation document. It is used during onchain registration.

  3. `/process_data`: Contains your custom logic. You will write the code for this yourself. This is the endpoint that your app frontend will hit.
...
As an app developer, follow these steps to deploy a self-managed TEE. Alternatively, you can use the [Marlin Oyster marketplace](</sui-stack/nautilus/community-dev-tools>) for Docker-based simplicity.
  ...
  3. Register the platform configuration registers (PCRs) of the instance. PCRs are measurements of the trusted computing base. Use a Sui smart contract to register them.

  4. Deploy the server to an AWS Nitro Enclave.

  5. Register the deployed enclave using a Sui smart contract and attestation document. Include the ephemeral public key of the enclave for signing responses.
...
[Edit this page](<https://github.com/MystenLabs/sui/tree/main/docs/docs/../content/sui-stack/nautilus/nautilus-design.mdx>)

[PreviousWhat is Nautilus?](</sui-stack/nautilus/nautilus-overview>)[NextUsing Nautilus](</sui-stack/nautilus/using-nautilus>)
