<!-- Source: https://docs.sui.io/sui-stack/nautilus/nautilus-weather-oracle -->
...
Alternatively, you can use the [Move web IDE](<https://www.playmove.dev/>), which does not require a download. It does not support all functions necessary for this guide, however.
  ...
  * A [weatherapi.com](<https://www.weatherapi.com/>) API key (free tier)
...
File not found in manifest: `K4/example/move/weather.move`. You probably need to run `pnpm prebuild` and restart the site.
...
[Edit this page](<https://github.com/MystenLabs/sui/tree/main/docs/docs/../content/sui-stack/nautilus/nautilus-weather-oracle.mdx>)

[PreviousCustomizing, Testing, and Management](</sui-stack/nautilus/customize-nautilus>)[NextEncrypt Enclave Secrets with Seal](</sui-stack/nautilus/seal>)
