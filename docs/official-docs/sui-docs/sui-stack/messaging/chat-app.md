<!-- Source: https://docs.sui.io/sui-stack/messaging/chat-app -->
...
File not found in manifest: `move/packages/sui_stack_messaging/sources/seal_policies.move`. You probably need to run `pnpm prebuild` and restart the site.
...
File not found in manifest: `move/packages/sui_stack_messaging/sources/messaging.move`. You probably need to run `pnpm prebuild` and restart the site.
...
File not found in manifest: `move/packages/sui_stack_messaging/sources/encryption_history.move`. You probably need to run `pnpm prebuild` and restart the site.
...
File not found in manifest: `chat-app/src/hooks/useMessages.ts`. You probably need to run `pnpm prebuild` and restart the site.
...
[Edit this page](<https://github.com/MystenLabs/sui/tree/main/docs/docs/../content/sui-stack/messaging/chat-app.mdx>)

[PreviousCommunity Contributed](</sui-stack/messaging/community-contributed>)[NextSuiNS](</sui-stack/suins/>)
