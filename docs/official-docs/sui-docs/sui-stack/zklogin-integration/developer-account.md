<!-- Source: https://docs.sui.io/sui-stack/zklogin-integration/developer-account -->
...
Enter the domain name of your app (for example, example-app.com) and the redirect URL that will receive the authorization code from Apple (for example, <https://example-app.com/redirect>). Apple does not allow localhost or IP addresses as valid domains or redirect URLs.
...
[Edit this page](<https://github.com/MystenLabs/sui/tree/main/docs/docs/../content/sui-stack/zklogin-integration/developer-account.mdx>)

[PreviousWhat is zkLogin?](</sui-stack/zklogin-integration/zklogin>)[NextzkLogin Authentication](</sui-stack/zklogin-integration/zklogin-demo>)
