<!-- Source: https://docs.sui.io/sui-stack/zklogin-integration/ -->
...
zkLogin uses the user salt to compute the zkLogin Sui address (see [definition](</sui-stack/zklogin-integration>)). The salt must be a 16-byte value or an integer smaller than `2n**128n`. There are several options for the application to maintain the user salt:
...
If you want to use the Mysten hosted ZK Proving Service for Mainnet, refer to the [Enoki docs](<https://docs.enoki.mystenlabs.com/>) and contact us for access.
...
[code] $ wget -O - https://raw.githubusercontent.com/sui-foundation/zklogin-ceremony-contributions/main/download-main-zkey.sh | bash  
           
[/code]

     * Test zkey (for Devnet)
[code] $ wget -O - https://raw.githubusercontent.com/sui-foundation/zklogin-ceremony-contributions/main/download-test-zkey.sh | bash  
...
[Edit this page](<https://github.com/MystenLabs/sui/tree/main/docs/docs/../content/sui-stack/zklogin-integration/index.mdx>)

[PreviousCommunity Developer Tools](</sui-stack/nautilus/community-dev-tools>)[NextWhat is zkLogin?](</sui-stack/zklogin-integration/zklogin>)
