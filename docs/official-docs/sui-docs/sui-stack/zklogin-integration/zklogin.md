<!-- Source: https://docs.sui.io/sui-stack/zklogin-integration/zklogin -->
...
At a high level, the zkLogin protocol works as follows:
  ...
  4. Instead of deriving the Sui address based on a public key, the zkLogin address is derived from `sub` (user identifier), `iss` (provider), `aud` (application), and `user_salt` (a value that unlinks the OAuth identifier from the onchain address).


![zkLogin flow diagram](/assets/images/zklogin-steps_zklogin_v1-004e7cf76cd11fe97e3b7128b81114cc.png)
...
![zkLogin authority](/assets/images/zklogin-authority_zklogin_v1-59683e6b245197d66d614bcf80c98365.png)
...
[code] $ sui keytool zk-login-sig-verify --sig $ZKLOGIN_SIG --bytes $BYTES --intent-scope 3 --network devnet --curr-epoch 3  
...
[Edit this page](<https://github.com/MystenLabs/sui/tree/main/docs/docs/../content/sui-stack/zklogin-integration/zklogin.mdx>)

[PreviouszkLogin Integration](</sui-stack/zklogin-integration/>)[NextConfigure OpenID Providers](</sui-stack/zklogin-integration/developer-account>)
