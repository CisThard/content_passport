<!-- Source: https://docs.sui.io/sui-stack/zklogin-integration/zklogin-demo -->

* [](</>)
  * [zkLogin](</sui-stack/zklogin-integration/>)
...
File not found in manifest: `K2/src/hooks/useEphemeral.ts`. You probably need to run `pnpm prebuild` and restart the site.
...
File not found in manifest: `K2/src/hooks/useOauthPopup.tsx`. You probably need to run `pnpm prebuild` and restart the site.
...
File not found in manifest: `K2/src/hooks/useZkProof.ts`. You probably need to run `pnpm prebuild` and restart the site.
...
File not found in manifest: `K2/src/hooks/useWallet.ts`. You probably need to run `pnpm prebuild` and restart the site.
...
File not found in manifest: `K2/src/services/sui/writeClient.ts`. You probably need to run `pnpm prebuild` and restart the site.
...
File not found in manifest: `K2/src/utils/zk.ts`. You probably need to run `pnpm prebuild` and restart the site.
...
[Edit this page](<https://github.com/MystenLabs/sui/tree/main/docs/docs/../content/sui-stack/zklogin-integration/zklogin-demo.mdx>)

[PreviousConfigure OpenID Providers](</sui-stack/zklogin-integration/developer-account>)[NextSuiPlay0X1 Development Guide for Game Developers](</sui-stack/suiplay0x1/>)
