<!-- Source: https://docs.sui.io/sui-stack/on-chain-primitives/randomness-onchain -->
...
`Random` has a reserved address `0x8`. See [`random.move`](</references/framework/sui-framework/sui_sui/random>) for the Move APIs that access randomness on Sui.
...
[Edit this page](<https://github.com/MystenLabs/sui/tree/main/docs/docs/../content/sui-stack/on-chain-primitives/randomness-onchain.mdx>)

[PreviousAccess Onchain Time](</sui-stack/on-chain-primitives/access-time>)[NextSagat](</sui-stack/sagat>)
