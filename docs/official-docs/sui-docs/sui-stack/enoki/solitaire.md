<!-- Source: https://docs.sui.io/sui-stack/enoki/solitaire -->
...
File not found in manifest: `move/solitaire/sources/solitaire.move`. You probably need to run `pnpm prebuild` and restart the site.
...
File not found in manifest: `app/src/components/gameBoard/GameBoard.tsx`. You probably need to run `pnpm prebuild` and restart the site.
...
File not found in manifest: `app/src/hooks/useSolitaireActions.ts`. You probably need to run `pnpm prebuild` and restart the site.
...
[Edit this page](<https://github.com/MystenLabs/sui/tree/main/docs/docs/../content/sui-stack/enoki/solitaire.mdx>)

[PreviousDomain Names with SuiNS](</sui-stack/suins/sui-stack-suins>)[NextTicketing Platform](</sui-stack/enoki/ticketing-poc>)
