<!-- Source: https://docs.sui.io/sui-stack/sagat -->
...
![Sagat connect Slush](/assets/images/sagat-1-52f31f692841920587616eb75b216257.png)
...
![Sagat authenticate Slush](/assets/images/sagat-2-5e0481d578cdc733f0007bfa885388b3.png)
...
![Sagat Create Your First Multisig](/assets/images/sagat-3-5bda6cf3a7a37ac855e945c46bc9c0e9.png)

You must add at least 2 addresses to create a multisig and set the approval threshold before the multisig can be created.

![Sagat create multisig](/assets/images/sagat-4-03cd713f72d49766b1e6b4dc6703b462.png)
...
![Sagat lookup public key](/assets/images/sagat-5-f2d0fa83736c12dbffb3ce0b31222cb1.png)

Then enter their Sui address. The address's public key is returned.

![Sagat lookup public key](/assets/images/sagat-6-b03f366429c0cc7c489d68b272b22145.png)
...
![Sagat multisig preview](/assets/images/sagat-7-862fbd127cf26336bd8d8ed83fb25a2c.png)
...
![Sagat multisig invitations](/assets/images/sagat-8-3fb4a6155e8fe739b77676330e79bdfb.png)
...
![Sagat dashboard](/assets/images/sagat-9-c12c8f082ff24ccb947f9a7389c81e9c.png)
...
![Sagat external proposers](/assets/images/sagat-10-73a190c78a8355231c41461d8cd339f4.png)
...
![Sagat signature analyzer](/assets/images/sagat-11-574beb4783857b667d2e8a30a3f809d2.png)
...
File not found in manifest: `api/test/addresses.test.ts`. You probably need to run `pnpm prebuild` and restart the site.
...
File not found in manifest: `api/test/multisig-api.test.ts`. You probably need to run `pnpm prebuild` and restart the site.
...
File not found in manifest: `api/test/multisig.test.ts`. You probably need to run `pnpm prebuild` and restart the site.
...
File not found in manifest: `api/test/proposal-business-logic.test.ts`. You probably need to run `pnpm prebuild` and restart the site.
...
[Edit this page](<https://github.com/MystenLabs/sui/tree/main/docs/docs/../content/sui-stack/sagat.mdx>)

[PreviousOnchain Randomness](</sui-stack/on-chain-primitives/randomness-onchain>)[NextWalrus](</sui-stack/walrus/>)
