<!-- Source: https://docs.sui.io/sui-stack/walrus/sui-stack-walrus-sites -->

* [](</>)
  * [Walrus](</sui-stack/walrus/>)
  * Onchain Websites with Walrus Sites
...
[code]
    Deploy this static frontend as a Walrus Site. Build the app, publish the site, record the site object and blob IDs, and document update steps.
[/code]
...
By the end of this guide, you can:
  ...
  * [Sui CLI](</getting-started/onboarding/sui-install>) installed
  * `suiup` installed: `curl -sSfL https://raw.githubusercontent.com/Mystenlabs/suiup/main/install.sh | sh`
  * `site-builder` installed: `suiup install site-builder@mainnet`
  * A funded wallet with WAL tokens for storage costs
...
File not found in manifest: `examples/snake/ws-resources.json`. You probably need to run `pnpm prebuild` and restart the site.
...
[Edit this page](<https://github.com/MystenLabs/sui/tree/main/docs/docs/../content/sui-stack/walrus/sui-stack-walrus-sites.mdx>)

[PreviousEncrypted Social Media](</sui-stack/walrus/only-fins>)[NextSeal](</sui-stack/seal/>)
