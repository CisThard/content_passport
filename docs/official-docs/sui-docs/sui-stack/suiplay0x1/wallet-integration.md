<!-- Source: https://docs.sui.io/sui-stack/suiplay0x1/wallet-integration -->
...
This option is effectively a special case of the recommended approach. If your game uses a game-specific zkLogin wallet, you still need to support using the Playtron wallet on the device.
  ...
  * If users have initially played the game off-device using your game-specific zkLogin wallet, they can use our companion app to link their wallet and transfer assets from that wallet to their Playtron zkLogin wallet to continue playing on-device. See [Cross-Platform Migration Strategies](</sui-stack/suiplay0x1/migration-strategies>) to learn more.
...
**Tradeoffs**
  ...
  * Unlike custodial wallets, users still need to pay for gas. You can always [sponsor transactions](<https://docs.sui.io/develop/transaction-payment/sponsor-txn>) instead to assume this responsibility.
...
A SuiLink connection is automatically established for SuiPlay0X1 users onboarded in the Playtron wallet app. You can query a user's SuiLink objects to validate that they own a specific asset. For more information, refer to our [separate guide on using SuiLink](</onchain-finance/asset-custody/wallets/suilink>).

[Edit this page](<https://github.com/MystenLabs/sui/tree/main/docs/docs/../content/sui-stack/suiplay0x1/wallet-integration.mdx>)

[PreviousSDK Integrations](</sui-stack/suiplay0x1/integration>)[NextBest Practices](</sui-stack/suiplay0x1/best-practices>)
