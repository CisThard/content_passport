<!-- Source: https://docs.sui.io/getting-started/dev-cheat-sheet -->
...
[Edit this page](<https://github.com/MystenLabs/sui/tree/main/docs/docs/../content/getting-started/dev-cheat-sheet.mdx>)

[NextEthereum -> Sui](</getting-started/sui-for-ethereum>)
