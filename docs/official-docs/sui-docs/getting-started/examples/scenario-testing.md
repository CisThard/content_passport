<!-- Source: https://docs.sui.io/getting-started/examples/scenario-testing -->
...
[code]
    Create scenario tests for this Sui workflow, including multiple users, object ownership changes, and expected transaction failures.
[/code]
...
File not found in manifest: `G1/scenario/sources/acl.move`. You probably need to run `pnpm prebuild` and restart the site.
...
File not found in manifest: `G1/scenario/sources/hero.move`. You probably need to run `pnpm prebuild` and restart the site.
...
File not found in manifest: `G1/scenario/tests/hero_tests.move`. You probably need to run `pnpm prebuild` and restart the site.
...
File not found in manifest: `G1/scenario/tests/acl_tests.move`. You probably need to run `pnpm prebuild` and restart the site.
...
[Edit this page](<https://github.com/MystenLabs/sui/tree/main/docs/docs/../content/getting-started/examples/scenario-testing.mdx>)

[PreviousDerived Objects](</getting-started/examples/derived-objects>)[NextdApp Kit](</getting-started/examples/dapp-kit-frontend>)
