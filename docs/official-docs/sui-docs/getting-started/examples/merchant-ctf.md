<!-- Source: https://docs.sui.io/getting-started/examples/merchant-ctf -->
...
File not found in manifest: `contracts/sources/merchant.move`. You probably need to run `pnpm prebuild` and restart the site.
...
[Edit this page](<https://github.com/MystenLabs/sui/tree/main/docs/docs/../content/getting-started/examples/merchant-ctf.mdx>)

[PreviousLootbox](</getting-started/examples/lootbox-ctf>)[NextStaking with Time-Accumulation](</getting-started/examples/staking-ctf>)
