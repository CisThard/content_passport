<!-- Source: https://docs.sui.io/getting-started/examples/derived-objects -->
...
File not found in manifest: `C5/contracts/derived_objects/sources/parent.move`. You probably need to run `pnpm prebuild` and restart the site.
...
File not found in manifest: `C5/ts/src/helpers/deriveObjectID.ts`. You probably need to run `pnpm prebuild` and restart the site.
...
[Edit this page](<https://github.com/MystenLabs/sui/tree/main/docs/docs/../content/getting-started/examples/derived-objects.mdx>)

[PreviousCapability Pattern](</getting-started/examples/capability-pattern>)[NextScenario Testing](</getting-started/examples/scenario-testing>)
