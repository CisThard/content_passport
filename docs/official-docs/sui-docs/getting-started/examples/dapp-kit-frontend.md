<!-- Source: https://docs.sui.io/getting-started/examples/dapp-kit-frontend -->
...
File not found in manifest: `E2/my-first-sui-dapp/src/dapp-kit.ts`. You probably need to run `pnpm prebuild` and restart the site.
...
File not found in manifest: `E2/my-first-sui-dapp/src/components/ui/MintNFTForm.tsx`. You probably need to run `pnpm prebuild` and restart the site.
...
File not found in manifest: `E2/my-first-sui-dapp/src/OwnedObjects.tsx`. You probably need to run `pnpm prebuild` and restart the site.
...
File not found in manifest: `E2/my-first-sui-dapp/src/main.tsx`. You probably need to run `pnpm prebuild` and restart the site.
...
[Edit this page](<https://github.com/MystenLabs/sui/tree/main/docs/docs/../content/getting-started/examples/dapp-kit-frontend.mdx>)

[PreviousScenario Testing](</getting-started/examples/scenario-testing>)[NextNFT Minting App](</getting-started/examples/nft-app>)
