<!-- Source: https://docs.sui.io/references/cli/replay -->
...
The response above provides the transaction effects information, gas report, and a more detailed list of the each object's size and cost. For more information about the gas cost, refer to the [gas in Sui](</develop/transaction-payment/gas-in-sui>) page.
...
[Edit this page](<https://github.com/MystenLabs/sui/tree/main/docs/docs/../content/references/cli/replay.mdx>)

[PreviousSui Move CLI](</references/cli/move>)[NextSui Trace Analysis](</references/cli/trace-analysis>)
