<!-- Source: https://docs.sui.io/references/ts-asset-tokenization -->
...
[code] struct AssetCap<phantom T> {  
            id: UID,  
...
[code] struct AssetMetadata<phantom T> has key, store {  
                id: UID,  
                /// Name of the asset  
                name: String,  
                // the total max supply allowed to exist at any time  
...
[code] struct TokenizedAsset<phantom T> has key, store {  
                id: UID,  
...
[code] /// Capability that is issued to the one deploying the contract  
...
[code] public fun new_asset<T: drop>(  
                witness: T,  
                total_supply: u64,  
                symbol: ascii::String,  
                name: String,  
...
[code] public fun total_supply<T>(cap: &AssetCap<T>): u64 {}  
...
[code] public fun supply<T>(cap: &AssetCap<T>): u64 {}  
...
[code] public fun value<T>(tokenized_asset: &TokenizedAsset<T>): u64 {}  
...
[code] fun create_vec_map_from_arrays(  
                keys: vector<String>,  
                values: vector<String>  
...
[code] struct ProtectedTP<phantom T> has key, store {  
                id: UID,  
...
[code] fun init(otw: PROXY, ctx: &mut TxContext) {}  
...
[code] public fun setup_tp<T: drop>(  
                registry: &Registry,  
                publisher: &Publisher,  
                ctx: &mut TxContext  
...
[code] public fun new_display<T: drop>(  
                registry: &Registry,  
                publisher: &Publisher,  
                ctx: &mut TxContext  
...
[code] public(friend) fun transfer_policy<T>(  
...
[code] public fun asset_from_kiosk_to_join<T>(  
...
[code] public fun asset_from_kiosk_to_burn<T>(  
...
[Edit this page](<https://github.com/MystenLabs/sui/tree/main/docs/docs/../content/references/ts-asset-tokenization.mdx>)
