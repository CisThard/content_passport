<!-- Source: https://docs.sui.io/references/rust-sdk -->
...
You must specify the key scheme, one of `ed25519` or `secp256k1` or `secp256r1`. You can skip this step if you are going to play with a friend. :)
  ...
  2. Publish the move contract
     ...
     2. Publish the [`tic-tac-toe` package](<https://github.com/MystenLabs/sui/tree/main/examples/tic-tac-toe/move>) using the Sui client:
[code]sui client publish --path /path-to-sui-source-code/examples/tic-tac-toe/move
...
[code]cargo run -- new --package-id <<tic-tac-toe package object ID>> <<player O address>>
...
[code] cargo run -- move --package-id <<tic-tac-toe package object ID>> --row $R --col $C <<game ID>>
...
[Edit this page](<https://github.com/MystenLabs/sui/tree/main/docs/docs/../content/references/rust-sdk.mdx>)

[PreviousSDK Comparison](</references/sdk-comparison>)[NextMove References](</references/sui-move>)
