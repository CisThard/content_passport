<!-- Source: https://docs.sui.io/references/sui-api/rpc-best-practices -->
...
[Edit this page](<https://github.com/MystenLabs/sui/tree/main/docs/docs/../content/references/sui-api/rpc-best-practices.mdx>)

[PreviousEnum and Scalar Types](</references/fullnode-protocol-types>)[NextSui CLI](</references/cli>)
