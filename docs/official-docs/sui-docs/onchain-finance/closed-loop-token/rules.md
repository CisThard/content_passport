<!-- Source: https://docs.sui.io/onchain-finance/closed-loop-token/rules -->
...
[Edit this page](<https://github.com/MystenLabs/sui/tree/main/docs/docs/../content/onchain-finance/closed-loop-token/rules.mdx>)

[PreviousAction Request](</onchain-finance/closed-loop-token/action-request>)[NextSpending](</onchain-finance/closed-loop-token/spending>)
