<!-- Source: https://docs.sui.io/onchain-finance/closed-loop-token/action-request -->
...
[Edit this page](<https://github.com/MystenLabs/sui/tree/main/docs/docs/../content/onchain-finance/closed-loop-token/action-request.mdx>)

[PreviousToken Policy](</onchain-finance/closed-loop-token/token-policy>)[NextRules](</onchain-finance/closed-loop-token/rules>)
