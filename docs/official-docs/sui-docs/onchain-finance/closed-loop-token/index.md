<!-- Source: https://docs.sui.io/onchain-finance/closed-loop-token/ -->
...
![Difference with coin](/assets/images/difference-with-coin_closed-loop-token_v1-fc11d6cb730fe44366be0fda5be77b82.png)
...
[Edit this page](<https://github.com/MystenLabs/sui/tree/main/docs/docs/../content/onchain-finance/closed-loop-token/index.mdx>)

[NextToken Policy](</onchain-finance/closed-loop-token/token-policy>)
