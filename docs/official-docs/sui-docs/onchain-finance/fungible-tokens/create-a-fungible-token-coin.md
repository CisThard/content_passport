<!-- Source: https://docs.sui.io/onchain-finance/fungible-tokens/create-a-fungible-token-coin -->

* [](</>)
  * [Fungible Tokens](</onchain-finance/fungible-tokens/>)
  * [Coin Standard](</onchain-finance/fungible-tokens/coin>)
...
File not found in manifest: `I1/silver/sources/silver.move`. You probably need to run `pnpm prebuild` and restart the site.
...
[View the full example](<https://github.com/MystenLabs/sui-move-bootcamp/blob/main/I1>) or learn more about the [Coin Standard](<https://docs.sui.io/onchain-finance/fungible-tokens/coin>).
...
[Edit this page](<https://github.com/MystenLabs/sui/tree/main/docs/docs/../content/onchain-finance/fungible-tokens/create-a-fungible-token-coin.mdx>)

[PreviousCoin](</onchain-finance/fungible-tokens/coin>)[NextCurrency](</onchain-finance/fungible-tokens/currency>)
