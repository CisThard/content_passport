<!-- Source: https://docs.sui.io/onchain-finance/asset-custody/wallets/self-custody -->
...
File not found in manifest: `packages/dapp-kit-next/packages/dapp-kit-core/src/core/index.ts`. You probably need to run `pnpm prebuild` and restart the site.
...
File not found in manifest: `packages/dapp-kit-next/packages/dapp-kit-react/src/hooks/useWalletConnection.ts`. You probably need to run `pnpm prebuild` and restart the site.

File not found in manifest: `packages/dapp-kit-next/packages/dapp-kit-react/src/hooks/useCurrentWallet.ts`. You probably need to run `pnpm prebuild` and restart the site.

File not found in manifest: `packages/dapp-kit-next/packages/dapp-kit-react/src/hooks/useCurrentAccount.ts`. You probably need to run `pnpm prebuild` and restart the site.

### List available wallets​

File not found in manifest: `packages/dapp-kit-next/packages/dapp-kit-react/src/hooks/useWallets.ts`. You probably need to run `pnpm prebuild` and restart the site.

### Sign and execute a transaction​

File not found in manifest: `packages/dapp-kit-next/packages/dapp-kit-react/src/hooks/useDAppKit.ts`. You probably need to run `pnpm prebuild` and restart the site.
...
[Edit this page](<https://github.com/MystenLabs/sui/tree/main/docs/docs/../content/onchain-finance/asset-custody/wallets/self-custody.mdx>)

[PreviousSlush](</onchain-finance/asset-custody/wallets/slush>)[NextzkLogin Wallets](</onchain-finance/asset-custody/wallets/zk-login-wallets>)
