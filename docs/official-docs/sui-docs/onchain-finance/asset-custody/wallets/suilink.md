<!-- Source: https://docs.sui.io/onchain-finance/asset-custody/wallets/suilink -->
...
When building an application on Sui, you can integrate SuiLink to verify cross-chain ownership.
  ...
  * [Install and configure a Sui client instance](</getting-started/onboarding/configure-sui-client>).

  * [Install the Sui gRPC client to your project](<https://sdk.mystenlabs.com/sui/clients/grpc>).
...
[Edit this page](<https://github.com/MystenLabs/sui/tree/main/docs/docs/../content/onchain-finance/asset-custody/wallets/suilink.mdx>)

[PreviouszkLogin Wallets](</onchain-finance/asset-custody/wallets/zk-login-wallets>)[NextFungible Tokens](</onchain-finance/fungible-tokens/>)
