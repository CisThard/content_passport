<!-- Source: https://docs.sui.io/onchain-finance/examples-patterns/wasm-template -->
...
[Edit this page](<https://github.com/MystenLabs/sui/tree/main/docs/docs/../content/onchain-finance/examples-patterns/wasm-template.mdx>)

[PreviousKiosk Joining Patterns](</onchain-finance/examples-patterns/kiosk>)[NextClosed-Loop Token](</onchain-finance/closed-loop-token/>)
