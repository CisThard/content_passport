<!-- Source: https://docs.sui.io/onchain-finance/deepbookv3/deepbookv3-indexer -->
...
Click to openGet all pool information
[code]
    /get_pools  
...
Click to openGet historical volume for pool in a specific time range
[code]
...
Click to openGet historical volume for all pools
[code]
...
Click to openGet historical volume by balance manager
[code]
...
Click to openGet historical volume by balance manager within a specific time range and intervals
[code]
...
Click to openGet ticker information
[code]
    /ticker  
...
Click to openGet order updates
[code]
...
Click to openGet order book information
[code]
...
Click to openGet asset information
[code]
    /assets  
...
Click to openGet orders by balance manager
[code]
...
Click to openGet OHLCV candlestick data
[code]
...
Click to openGet deposited assets
[code]
...
Click to openGet indexer status
[code]
...
Click to openGet margin supply
[code]
    /margin_supply  
...
Click to openGet pool creation events
[code]
    /pool_created  
...
Click to openGet book parameters updated events
[code]
...
Click to openGet user portfolio
[code]
...
Click to openGet referral fee events
[code]
...
[Edit this page](<https://github.com/MystenLabs/sui/tree/main/docs/docs/../content/onchain-finance/deepbookv3/deepbookv3-indexer.mdx>)

[PreviousStaking and Governance](</onchain-finance/deepbookv3-sdk/staking-governance>)[NextDeepBook Margin](</onchain-finance/deepbook-margin/>)
