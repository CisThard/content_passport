<!-- Source: https://docs.sui.io/onchain-finance/deepbook-predict/design -->
...
Applications should split reads by freshness and purpose:
  ...
  2. Subscribe to Sui checkpoints or events for second-level oracle updates when the UI needs a live tape.
...
[Edit this page](<https://github.com/MystenLabs/sui/tree/main/docs/docs/../content/onchain-finance/deepbook-predict/design.mdx>)

[PreviousDeepBook Predict](</onchain-finance/deepbook-predict/>)[NextContract Information](</onchain-finance/deepbook-predict/contract-information>)
