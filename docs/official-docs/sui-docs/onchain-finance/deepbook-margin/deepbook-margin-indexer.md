<!-- Source: https://docs.sui.io/onchain-finance/deepbook-margin/deepbook-margin-indexer -->
...
Click to openGet margin manager creation events
[code]
...
Click to openGet loan borrowed events
[code]
...
Click to openGet loan repaid events
[code]
...
Click to openGet liquidation events
[code]
...
Click to openGet margin managers information
[code]
...
Click to openGet margin manager states
[code]
...
Click to openGet asset supplied events
[code]
...
Click to openGet asset withdrawn events
[code]
...
Click to openGet margin pool creation events
[code]
...
Click to openGet DeepBook pool updated events
[code]
...
Click to openGet interest parameter update events
[code]
...
Click to openGet margin pool configuration update events
[code]
...
Click to openGet supplier cap minted events
[code]
...
Click to openGet supply referral minted events
[code]
...
Click to openGet protocol fees increased events
[code]
...
Click to openGet referral fees claimed events
[code]
...
Click to openGet collateral events
[code]
...
Click to openGet maintainer cap updated events
[code]
...
Click to openGet maintainer fees withdrawn events
[code]
...
Click to openGet protocol fees withdrawn events
[code]
...
Click to openGet pause cap updated events
[code]
...
Click to openGet DeepBook pool registered events
[code]
...
Click to openGet DeepBook pool registry updated events
[code]
...
Click to openGet DeepBook pool config updated events
[code]
...
[Edit this page](<https://github.com/MystenLabs/sui/tree/main/docs/docs/../content/onchain-finance/deepbook-margin/deepbook-margin-indexer.mdx>)

[PreviousTake Profit Stop Loss](</onchain-finance/deepbook-margin-sdk/tpsl>)[NextDeepBook Predict](</onchain-finance/deepbook-predict/>)
