<!-- Source: https://docs.sui.io/operators/data-management/remote-store-setup -->
...
---|---|---  
`--config <PATH>`| —| Path to optional TOML configuration file. The framework defaults are sufficient for most deployments. See Configuration.  
...
[Edit this page](<https://github.com/MystenLabs/sui/tree/main/docs/docs/../content/operators/data-management/remote-store-setup.mdx>)

[PreviousGraphQL and General-Purpose Indexer](</operators/data-management/indexer-stack-setup>)[NextRunning the Archival Store and Service](</operators/data-management/archival-stack-setup>)
