<!-- Source: https://docs.sui.io/develop/accessing-data/grpc/using-grpc -->
...
[code]
    Convert this Sui JSON-RPC usage to the current gRPC API. Generate/use the client, map request/response types, and add a working example.
[/code]
...
[Edit this page](<https://github.com/MystenLabs/sui/tree/main/docs/docs/../content/develop/accessing-data/grpc/using-grpc.mdx>)

[PreviousWhat is gRPC?](</develop/accessing-data/grpc/what-is-grpc>)[NextGraphQL](</develop/accessing-data/graphql/>)
