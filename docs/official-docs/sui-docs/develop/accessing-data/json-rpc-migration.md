<!-- Source: https://docs.sui.io/develop/accessing-data/json-rpc-migration -->
...
Click to opengRPC and GraphQL examples
...
[Edit this page](<https://github.com/MystenLabs/sui/tree/main/docs/docs/../content/develop/accessing-data/json-rpc-migration.mdx>)

[PreviousData Access Interfaces](</develop/accessing-data/data-serving>)[NextgRPC](</develop/accessing-data/grpc/>)
