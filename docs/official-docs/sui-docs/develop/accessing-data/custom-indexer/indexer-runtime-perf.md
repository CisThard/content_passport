<!-- Source: https://docs.sui.io/develop/accessing-data/custom-indexer/indexer-runtime-perf -->
...
# Optimize Indexer Runtime and Performance
...
[/code]
  ...
  3. Run with console enabled

Start your indexer with the required flags:
[code] RUSTFLAGS="--cfg tokio_unstable" TOKIO_CONSOLE=1 cargo run  
...
**Flag explanations:**
  ...
  4. Launch the console dashboard
[code] # Install tokio-console if not already installed  
...
![Tokio console](/assets/images/tokio-8d85dea2cabfa8964945f47183d545f3.png)
...
The `sui-indexer-alt-framework` provides built-in Prometheus metrics for monitoring indexer performance and health. All metrics are automatically exposed through HTTP and can be extended with custom metrics.
...
By default, metrics are served on `0.0.0.0:9184/metrics` in [Prometheus format](<https://prometheus.io/docs/develop/sui-architecture/object-model>). You can override this address:

  * Through the command line:
[code] $ cargo run --metrics-address "0.0.0.0:8080"  
        
[/code]

  * Or, through the builder configuration:
[code] let cluster = IndexerCluster::builder()  
...
[Edit this page](<https://github.com/MystenLabs/sui/tree/main/docs/docs/../content/develop/accessing-data/custom-indexer/indexer-runtime-perf.mdx>)

[PreviousIntegrate Data Sources](</develop/accessing-data/custom-indexer/indexer-data-integration>)[NextCryptography](</develop/cryptography/>)
