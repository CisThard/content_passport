<!-- Source: https://docs.sui.io/develop/transactions/transaction-lifecycle -->
...
![Transaction life cycle](/assets/images/transaction_lifecycle_v2-9990d0aed43d98b0f7edc932246b31f2.svg)
...
Sui's parallel execution engine executes transactions emitted by consensus. Transactions that don't conflict on inputs execute completely in parallel. Transaction execution produces the _transaction effects_: the list of all actions the transaction took:
...
[Edit this page](<https://github.com/MystenLabs/sui/tree/main/docs/docs/../content/develop/transactions/transaction-lifecycle.mdx>)

[PreviousWhat is a Transaction?](</develop/transactions/txn-overview>)[NextProgrammable Transaction Blocks](</develop/transactions/ptbs/>)
