<!-- Source: https://docs.sui.io/develop/transactions/transaction-auth/auth-overview -->
...
m/purpose′/cointype′/account′/change/addressindexm / purpose' / coin_type' / account' / change / address_indexm/purpose′/coint​ype′/account′/change/addressi​ndex
...
An accepted pure Ed25519 signature must follow:
  ...
  2. The signature must be valid according to [ZIP215](<https://github.com/zcash/zips/blob/main/zips/zip-0215.rst>).
...
[Edit this page](<https://github.com/MystenLabs/sui/tree/main/docs/docs/../content/develop/transactions/transaction-auth/auth-overview.mdx>)

[PreviousTransaction Authentication](</develop/transactions/transaction-auth/>)[NextMultisig Authentication](</develop/transactions/transaction-auth/multisig>)
