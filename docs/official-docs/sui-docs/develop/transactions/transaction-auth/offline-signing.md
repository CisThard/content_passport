<!-- Source: https://docs.sui.io/develop/transactions/transaction-auth/offline-signing -->
...
The following example demonstrates how to serialize data for a transfer using the [Sui CLI](</references/cli>). This returns serialized transaction data in Base64. Submit the raw transaction to execute as `tx_bytes`.
...
You can sign the data using the device and programming language of your choice. Sui accepts signatures for pure Ed25519, ECDSA Secp256k1, ECDSA Secp256r1, and native multisig. To learn more about the requirements of the signatures, see [Sui Signatures](</develop/transactions/transaction-auth/auth-overview>).
...
[Edit this page](<https://github.com/MystenLabs/sui/tree/main/docs/docs/../content/develop/transactions/transaction-auth/offline-signing.mdx>)

[PreviousIntent Signing](</develop/transactions/transaction-auth/intent-signing>)[NextAddress Aliases](</develop/transactions/transaction-auth/address-aliases>)
