<!-- Source: https://docs.sui.io/develop/transactions/ptbs/inputs-and-results -->
...
[code]
    Review this PTB code for invalid pure inputs, custom structs/enums, object references, vectors/options, and command result usage.
[/code]
...
[Edit this page](<https://github.com/MystenLabs/sui/tree/main/docs/docs/../content/develop/transactions/ptbs/inputs-and-results.mdx>)

[PreviousBuilding Transactions](</develop/transactions/ptbs/building-ptb>)[NextTransaction Authentication](</develop/transactions/transaction-auth/>)
