...
[Edit this page](<https://github.com/MystenLabs/sui/tree/main/docs/docs/../content/develop/write-move/move-best-practices.mdx>)

[PreviousMove Concepts](</develop/write-move/sui-move-concepts>)[NextPackages](</develop/publish-upgrade-packages/>)
