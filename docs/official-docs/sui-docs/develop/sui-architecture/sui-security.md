<!-- Source: https://docs.sui.io/develop/sui-architecture/sui-security -->
...
Sui is designed to provide high security guarantees to asset owners. Assets on Sui, including coins and tokens, are types of [objects](</develop/sui-architecture/object-model>), and can only be used by their owners unless otherwise defined according to predefined logic in a smart contract. Every smart contract can be audited, and the network can process them correctly even if some [validators](</develop/sui-architecture/consensus>) do not follow the protocol correctly. This is known as fault tolerance.
...
Sui's security features guarantee certain properties for objects:
  ...
  2. Everyone can operate on [shared](</develop/objects/object-ownership/shared>) objects or [immutable](</develop/objects/object-ownership/immutable>) objects, but additional access control logic can be implemented by a smart contract.
...
The Move smart contract language is designed with ease of audit and verification in mind. You might be interested in the [introduction to smart contracts in Move](</develop/write-move/sui-move-concepts>).
...
[Edit this page](<https://github.com/MystenLabs/sui/tree/main/docs/docs/../content/develop/sui-architecture/sui-security.mdx>)

[PreviousStorage](</develop/sui-architecture/sui-storage>)[NextProtocol Upgrades](</develop/sui-architecture/protocol-upgrades>)
