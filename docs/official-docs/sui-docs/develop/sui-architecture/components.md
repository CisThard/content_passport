<!-- Source: https://docs.sui.io/develop/sui-architecture/components -->
...
Sui is a layer 1 blockchain. Layer 1 networks consist of the following primary components:
  ...
  2. The [**consensus mechanism**](</develop/sui-architecture/consensus>) used to validate transactions.

  3. [**Transactions**](</develop/transactions/txn-overview>) themselves, which on Sui reflect onchain operations such as creating objects or sending assets.

  4. [**Tokens**](</develop/sui-architecture/tokenomics-overview>) used to pay for resources and transactions on the network.
...
On Sui specifically, other core components include:
  ...
  2. [**Move**](</develop/write-move/sui-move-concepts>), the programming language used to create smart contracts on Sui.
...
[Edit this page](<https://github.com/MystenLabs/sui/tree/main/docs/docs/../content/develop/sui-architecture/components.mdx>)

[PreviousSui Architecture](</develop/sui-architecture/>)[NextNetworks](</develop/sui-architecture/networks>)
