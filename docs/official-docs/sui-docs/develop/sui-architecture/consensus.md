<!-- Source: https://docs.sui.io/develop/sui-architecture/consensus -->
...
![Throughput and latency graph](/assets/images/thruput_latency-f3b49e4b2e14437e7428031682fa45a8.png)
...
For more details, including correctness proofs, see the [MYSTICETI: Reaching the Latency Limits with Uncertified DAGs](</assets/files/mysticeti-b7bf6bc1e0df4e363fd971dc51e11ac0.pdf>) whitepaper.

[Edit this page](<https://github.com/MystenLabs/sui/tree/main/docs/docs/../content/develop/sui-architecture/consensus.mdx>)

[PreviousNetworks](</develop/sui-architecture/networks>)[NextTokenomics](</develop/sui-architecture/tokenomics-overview>)
