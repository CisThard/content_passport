<!-- Source: https://docs.sui.io/develop/cryptography/groth16 -->
...
Recall that this creates a proof that the prover knows a factorization, in this case of the [5th Fermat number](<https://en.wikipedia.org/wiki/Fermat_number#Factorization>) (232 \+ 1 = 4294967297 = 641 * 6700417).
...
[Edit this page](<https://github.com/MystenLabs/sui/tree/main/docs/docs/../content/develop/cryptography/groth16.mdx>)

[PreviousHashing](</develop/cryptography/hashing>)[NextECVRF](</develop/cryptography/ecvrf>)
