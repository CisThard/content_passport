<!-- Source: https://docs.sui.io/develop/objects/transfers/simulating-refs -->
...
Everything on the Sui blockchain is an object. When you develop Move packages for the Sui network, you typically manipulate or use onchain objects in some way through functionality available in the Sui API. For most API functions, you provide an object by reference.
...
[Edit this page](<https://github.com/MystenLabs/sui/tree/main/docs/docs/../content/develop/objects/transfers/simulating-refs.mdx>)

[PreviousTransfer to Object](</develop/objects/transfers/transfer-to-object>)[NextWriting Move Packages](</develop/write-move/>)
