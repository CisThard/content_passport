<!-- Source: https://docs.sui.io/develop/objects/versioning -->
...
Objects on Sui are versioned either through the fastpath or through [consensus](</develop/sui-architecture/consensus>). The choice affects object ownership options and has performance trade-offs.
...
[Edit this page](<https://github.com/MystenLabs/sui/tree/main/docs/docs/../content/develop/objects/versioning.mdx>)

[PreviousDynamic Fields](</develop/objects/dynamic-fields>)[NextObject Display](</develop/objects/display/>)
