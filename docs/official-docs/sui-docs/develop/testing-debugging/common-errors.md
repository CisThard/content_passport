<!-- Source: https://docs.sui.io/develop/testing-debugging/common-errors -->

* [](</>)
  * [Testing and Debugging](</develop/testing-debugging/>)
...
[code]
    Debug this Sui transaction failure. Inspect object refs, gas objects, ownership, versions, and suggest the minimal code or PTB change to make it execute.
[/code]
...
[Edit this page](<https://github.com/MystenLabs/sui/tree/main/docs/docs/../content/develop/testing-debugging/common-errors.mdx>)

[PreviousTesting and Debugging](</develop/testing-debugging/>)[NextTransactions](</develop/transactions/>)
