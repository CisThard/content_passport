<!-- Source: https://docs.sui.io/develop/transaction-payment/local-fee-markets -->
...
[Edit this page](<https://github.com/MystenLabs/sui/tree/main/docs/docs/../content/develop/transaction-payment/local-fee-markets.mdx>)

[PreviousGas Fees](</develop/transaction-payment/gas-in-sui>)[NextGasless Stablecoin Transfers](</develop/transaction-payment/gasless-stablecoin-transfers>)
