...
- [Walrus Memory](usage/memwal.md), the default async/sync client and its core methods
- [Manual methods](usage/memwal-manual.md), lower-level `remember_manual` / `recall_manual` / `embed`
- [with_memwal](usage/with-memwal.md), LangChain and OpenAI middleware
