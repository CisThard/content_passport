...
The easiest way to get your delegate key and account ID is through the [Walrus Memory dashboard](https://memory.walrus.xyz). See the [main Quick Start](../getting-started/quick-start.md) for detailed setup instructions.
...
> **Note:** These managed relayer endpoints are provided as a public good by Walrus Foundation.
...
> **Tip:** If you see `health check failed`, check that your relayer URL is reachable and your `MEMWAL_PRIVATE_KEY` env var is set.
...
- [How It Works](how-it-works.md), understand the architecture, message flow, and hook mechanics
- [Reference](reference.md), detailed breakdown of hooks, tools, CLI, and configuration
