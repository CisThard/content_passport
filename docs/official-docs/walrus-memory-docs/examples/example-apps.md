...
The repo includes ready-to-run apps in `apps/` that show different Walrus Memory integration patterns. This page focuses on app-level patterns, the basic SDK flow covered in [Quick Start](../getting-started/quick-start.md) and [Walrus Memory Usage](../sdk/usage/memwal.md).
...
[GitHub](https://github.com/MystenLabs/MemWal/tree/main/apps/app)
...
[GitHub](https://github.com/MystenLabs/MemWal/tree/main/apps/chatbot)
...
[GitHub](https://github.com/MystenLabs/MemWal/tree/main/apps/noter)
...
[GitHub](https://github.com/MystenLabs/MemWal/tree/main/apps/researcher)
