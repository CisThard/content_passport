...
> **Tip:** These paths aren't mutually exclusive. You can combine them - for example, use the **Default SDK** with the **AI Middleware**, or start with the **Managed Relayer** and move to **Self-Hosting** later. They all share the same backend and data layer.
...
Go to: [SDK Overview](../sdk/overview.md)
...
Go to: [Managed Relayer](../relayer/public-relayer.md)
...
Go to: [Self-Hosting](../relayer/self-hosting.md)
