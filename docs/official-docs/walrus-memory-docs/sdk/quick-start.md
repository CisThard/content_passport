...
| `serverUrl` | `string` | No | Relayer URL, use `https://relayer.memory.walrus.xyz` (Mainnet) or `https://relayer-staging.memory.walrus.xyz` (Testnet) for the managed relayer |
...
- [Usage](usage.md), all three clients in detail, namespace rules, and restore
- [API Reference](api-reference.md), full method signatures and config fields
