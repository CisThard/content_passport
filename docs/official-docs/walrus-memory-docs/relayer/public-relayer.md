...
- **Trust assumption** - the relayer sees plaintext during encryption and embedding. By using the managed relayer, you're trusting the Walrus Foundation-hosted instance with that data. See [Trust and Security Model](../fundamentals/architecture/data-flow-security-model.md) for details.
...
If you need full control over the trust boundary or your own dedicated instance, see [Self-Hosting](self-hosting.md).
