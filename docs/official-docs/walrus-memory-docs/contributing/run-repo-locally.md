...
> **Tip:** If you only work on TypeScript apps or docs, you don't need Rust.
...
> **Warning:** The apps depend on the SDK's compiled output. If you skip this step, apps fails to start with import errors.
...
For the full relayer setup guide, see [Self-Hosting](../relayer/self-hosting.md).
...
- [Run Docs Locally](run-docs-locally.md), just the docs site
- [Self-Hosting](../relayer/self-hosting.md), full relayer deployment
- [Environment Variables](../reference/environment-variables.md), relayer configuration
