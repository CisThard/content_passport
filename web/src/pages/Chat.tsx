...
export default function Chat() {
  ...
  const handleSendMessage = async (e: React.FormEvent) => {
    ...
    if (normalized.includes('passport') || normalized.includes('register') || normalized.includes('identity')) {
      ...
      responseText = 'The Authenticity Lab utilizes the 3-layer Agent Authenticity Checkpoint (AASE). It evaluates JPEG compression quantization artifacts via Error Level Analysis (ELA), kameraraw EXIF headers, and Gemini Flash refractions.'
